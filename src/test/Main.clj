...
(. trustStore (load (FileInputStream. (File. "C:\\Users\\cwx205128\\.keystore")) (. "changeit" toCharArray)))

(def sslcontext (.. SSLContexts custom (useTLS) (loadTrustMaterial trustStore (TrustSelfSignedStrategy.)) build))
